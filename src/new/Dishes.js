...
class Dishes extends Component {
    ...
    getDishList(){
        ...
        AsyncStorage.getItem('FoodilogToken').then((value) => {
            var REQUEST_URL = API.SERVER_URL + API.SERVICE_PORT + GET_MENU_URL + this.props.rid + '?token=' + value
            // var REQUEST_URL = API.SERVER_URL + API.SERVICE_PORT + GET_MENU_URL + '59106acb00827662e5cc77b4' + '?token=' + value
            fetch(REQUEST_URL, {
                method: 'GET',
                headers: { 
